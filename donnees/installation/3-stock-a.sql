...
-- Produits ------------------------------------------------------------
-- Morceau 1 sur 2 — à jouer dans l'ordre des lettres.
...
insert into installation_journal (fichier) values ('3-stock-a.sql')
  on conflict (fichier) do update set joue_le = now();

select '3-stock-a.sql' as "Fichier joué", (select count(*) || ' produits sur 36' from produits) as "Où ça en est";
