...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-03-17'
  ...
  where a.sharepoint_id = 977
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 891, e.id, c.id, t.id, 'sol parquet abîmé – mettre pate à bois', null, 'validee', u1.id, u2.id, timestamptz '2026-01-29', null
  from emplacements e
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '03' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 899, e.id, c.id, t.id, 'Neon salle de repos à changer', null, 'validee', u1.id, u2.id, timestamptz '2026-01-29', null
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 803
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 483, e.id, c.id, t.id, 'Changement flexible liseuse droite', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 483
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 492, e.id, c.id, t.id, 'Changement ampoule lampe bureau', '1', 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 492
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 504, e.id, c.id, t.id, 'Changement flexible liseuse droite', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement flexible liseuse droite'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 504
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 505, e.id, c.id, t.id, 'barre de pare douche à refixer', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 505
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 516, e.id, c.id, t.id, 'Changement flexible liseuse droite', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement flexible liseuse droite'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 516
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 517, e.id, c.id, t.id, 'Télérupteur appliques changé', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 632, e.id, c.id, t.id, 'Grand miroir côté armoire cassé', null, 'a_faire', u1.id, u2.id, timestamptz '2026-01-13', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '41' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 643, e.id, c.id, t.id, 'spot chambre à remplacer', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 664, e.id, c.id, t.id, 'frein de chute abattant WC non fonctionnel -', 'Acheter nouvel abattant', 'a_acheter', u1.id, u2.id, timestamptz '2026-01-13', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '45' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 666, e.id, c.id, t.id, 'Cadre porte SDB bois - décollé du mur', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 702, e.id, c.id, t.id, 'Grand miroir côté armoire cassé', null, 'a_faire', u1.id, u2.id, timestamptz '2026-01-13', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '47' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 703, e.id, c.id, t.id, 'spot chambre à remplacer', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'spot chambre à remplacer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 703
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 704, e.id, c.id, t.id, 'Lavabo bouché', 'Petite cuillère trouvée dans le siphon', 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-02'
  ...
  where a.sharepoint_id = 725
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 726, e.id, c.id, t.id, 'Changement support lait corporel', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'changement support lait corporel'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-02'
  ...
  where a.sharepoint_id = 762
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 772, e.id, c.id, t.id, 'Lèvre de douche à changer sur le côté pare douche', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 786, e.id, c.id, t.id, 'fuite mitigeur douche', 'voir stock B pour retrouver ref - @ Sarah le 6/01 et relance le 13/01', 'a_acheter', u1.id, u2.id, timestamptz '2026-01-13', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '56' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 787, e.id, c.id, t.id, 'Lèvre de douche à changer sur le côté pare douche', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Lèvre de douche à changer sur le côté pare douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 789
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 798, e.id, c.id, t.id, 'Refixer liseuse gauche', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 798
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 799, e.id, c.id, t.id, 'poignée porte principale à resserrer', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-01-13'
  ...
  where a.sharepoint_id = 799
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 815, e.id, c.id, t.id, 'liseuse gauche à resserer', null, 'validee', u1.id, u2.id, timestamptz '2026-01-13', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 727
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 588, e.id, c.id, t.id, 'Il faut changer la bouilloire', null, 'validee', u1.id, u2.id, timestamptz '2026-08-01', '2026-08-01'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 551
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 844, e.id, c.id, t.id, 'URGENT - Difficulté à fermer la porte qui mene à la cour', null, 'validee', u1.id, u2.id, timestamptz '2025-12-25', '2026-12-01'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 535
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 882, e.id, c.id, t.id, 'Serrer le bras liseuse côté droit', null, 'validee', u1.id, u2.id, timestamptz '2025-12-24', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté droit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 882
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 398, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 398
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 456, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 456
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 471, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 471
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 472, e.id, c.id, t.id, 'Resserrer la poignée de la porte d''entrée', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 589
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 595, e.id, c.id, t.id, 'flexible liseuse côté droit à resserer', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 595
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 667, e.id, c.id, t.id, 'La poignée de la fenêtre s''enlève', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 667
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 801, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 801
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 802, e.id, c.id, t.id, 'Serrer le bras liseuse côté droit', null, 'validee', u1.id, u2.id, timestamptz '2025-12-23', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté droit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 370
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 379, e.id, c.id, t.id, 'Lit côté gauche cassé', 'Au lieu de les agrafer ensemble, Mr Serafino les a viser', 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lit côté gauche cassé'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 379
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 412, e.id, c.id, t.id, 'Spot à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à changer'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 412
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 484, e.id, c.id, t.id, 'Télérupteur à changer - spot et leds', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Télérupteur à changer - spot et leds'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 484
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 506, e.id, c.id, t.id, 'Liseuse côté droit à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', null
  from emplacements e
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '24' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 507, e.id, c.id, t.id, 'Télérupteur à changer - spot et leds', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Télérupteur à changer - spot et leds'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 507
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 508, e.id, c.id, t.id, 'Spot à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à changer'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 508
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 691, e.id, c.id, t.id, 'Télérupteur à changer - appliques murales sautent', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Télérupteur à changer - appliques murales sautent'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 691
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 773, e.id, c.id, t.id, 'Télérupteur à changer - appliques murales sautent', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Télérupteur à changer - appliques murales sautent'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 773
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 774, e.id, c.id, t.id, 'Spot à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à changer'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-12'
  ...
  where a.sharepoint_id = 774
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 788, e.id, c.id, t.id, 'Liseuse côté gauche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-09-12', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Liseuse côté gauche à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 788
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 459, e.id, c.id, t.id, 'La poignée de la fenêtre s''enlève', null, 'validee', u1.id, u2.id, timestamptz '2025-02-12', '2025-03-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'La poignée de la fenêtre s''enlève'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 744
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 576, e.id, c.id, t.id, 'Changement du séche cheveux', null, 'validee', u1.id, u2.id, timestamptz '2025-11-25', '2025-11-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement du séche cheveux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-26'
  ...
  where a.sharepoint_id = 576
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 396, e.id, c.id, t.id, 'Fuite au niveau du bac de douche', null, 'validee', u1.id, u2.id, timestamptz '2025-11-16', '2025-11-16'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 396
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 469, e.id, c.id, t.id, 'flexible douche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-15', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible douche à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 469
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 399, e.id, c.id, t.id, 'Resserrer la poignée', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-12-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 399
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 447, e.id, c.id, t.id, 'La poignée de la fenêtre s''enlève', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'La poignée de la fenêtre s''enlève'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-12'
  ...
  where a.sharepoint_id = 447
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 473, e.id, c.id, t.id, 'Télérupteur à changer - appliques murales sautent', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-09-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Télérupteur à changer - appliques murales sautent'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 494
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 534, e.id, c.id, t.id, 'Plinthe de la fenêtre à recoller', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-12-23'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 548, e.id, c.id, t.id, 'Cache pile du coffre manquant', null, 'a_faire', u1.id, u2.id, timestamptz '2025-11-11', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '28' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 574, e.id, c.id, t.id, 'Serrer le bras liseuse côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 574
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 610, e.id, c.id, t.id, 'Serrer le bras liseuse côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-12-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 610
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 626, e.id, c.id, t.id, 'Cale porte à refixer (la piece est encore dans la chambre)', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'cale porte à refixer (la piece est encore dans la chambre)'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-12'
  ...
  where a.sharepoint_id = 626
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 634, e.id, c.id, t.id, 'Refixer le miroir grossissant', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer le miroir grossissant'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 641, e.id, c.id, t.id, 'Bac de douche à changer - URGENT', null, 'en_cours', u1.id, u2.id, timestamptz '2025-11-11', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '42' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 642, e.id, c.id, t.id, 'fenêtre se ferme mal', 'Changement de la poignée de fenêtre', 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2026-01-13'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-23'
  ...
  where a.sharepoint_id = 705
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 729, e.id, c.id, t.id, 'Il faut changer la bouilloire', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-11-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Il faut changer la bouilloire'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-02-23'
  ...
  where a.sharepoint_id = 743
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 745, e.id, c.id, t.id, 'Liseuse côté droit à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Liseuse côté droit à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-12'
  ...
  where a.sharepoint_id = 745
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 763, e.id, c.id, t.id, 'Spot à changer - côté du miroir', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-12'
  ...
  where a.sharepoint_id = 763
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 800, e.id, c.id, t.id, 'Serrer le bras liseuse côté droit', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté droit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-12'
  ...
  where a.sharepoint_id = 800
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 820, e.id, c.id, t.id, 'Spot noir à changer - en face de la chambre 38', null, 'validee', u1.id, u2.id, timestamptz '2025-11-11', '2025-03-12'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-04-22'
  ...
  where a.sharepoint_id = 455
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 819, e.id, c.id, t.id, 'Batterie du bloc secours à changer (celui en face de la chambre 28)', 'Le 16/11/25 Hedi a changé une seule batterie sur les deux et pour l''instant tout semble en ordre - je n''ai pas modifé le stock parce que d''après lui la batterie fonctionne encore à confirmer', 'validee', u1.id, u2.id, timestamptz '2025-03-11', '2025-11-16'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 819
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 615, e.id, c.id, t.id, 'flexible liseuse côté droit à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-10-28', '2025-11-16'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 615
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 616, e.id, c.id, t.id, 'flexible liseuse côté gauche à fixer', null, 'validee', u1.id, u2.id, timestamptz '2025-10-28', '2025-11-16'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 616
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 710, e.id, c.id, t.id, 'flexible liseuse côté gauche à fixer', null, 'validee', u1.id, u2.id, timestamptz '2025-10-28', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté gauche à fixer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 710
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 728, e.id, c.id, t.id, 'flexible liseuse côté droit à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-10-28', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté droit à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 728
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 824, e.id, c.id, t.id, 'Batterie du bloc secours à changer (celui en face de la chambre 44)', null, 'validee', u1.id, u2.id, timestamptz '2025-10-22', '2025-10-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-30'
  ...
  where a.sharepoint_id = 736
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 759, e.id, c.id, t.id, 'Détection de punaises de lit au niveau de la tête de lit constaté le 30/09/25 par la societe Ecoflair', 'Le 30/09/25 - Punaises constaté au niveau de la tête de lit - Le 01/10/25 Rachid a fait un traitement', 'validee', u1.id, u2.id, timestamptz '2025-09-30', '2025-01-10'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-10'
  ...
  where a.sharepoint_id = 759
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 760, e.id, c.id, t.id, 'Demande de vérification s''il y a la présence de punaises', 'Détection de punaises par la société Ecoflair - Punaises constaté au niveau de la tête de lit', 'validee', u1.id, u2.id, timestamptz '2025-09-30', '2025-09-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Demande de vérification s''il y a la présence de punaises'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-11'
  ...
  where a.sharepoint_id = 510
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 385, e.id, c.id, t.id, 'Serrer le bras liseuse côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-09-26', '2025-09-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 503
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 550, e.id, c.id, t.id, 'Mettre une vis pour l''aimant de la porte dorée armoire (haut)', null, 'validee', u1.id, u2.id, timestamptz '2025-09-26', '2025-09-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Mettre une vis pour l''aimant de la porte dorée armoire (haut)'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 550
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 843, e.id, c.id, t.id, 'Nettoyage du tuyau d''évacuation du séche linge', null, 'validee', u1.id, u2.id, timestamptz '2025-09-26', '2025-09-26'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 843
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 693, e.id, c.id, t.id, 'Il faut changer la bouilloire', null, 'validee', u1.id, u2.id, timestamptz '2025-09-22', '2025-09-22'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Il faut changer la bouilloire'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-06-15'
  ...
  where a.sharepoint_id = 686
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 823, e.id, c.id, t.id, 'Batterie du bloc secours à changer (celui en face de l''ascenseur)', null, 'validee', u1.id, u2.id, timestamptz '2025-09-17', '2025-10-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-09'
  ...
  where a.sharepoint_id = 676
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 816, e.id, c.id, t.id, 'Spot à coté de l''ascenseur à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-12-09', null
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 463, e.id, c.id, t.id, 'Spot plafond au fond à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-09', '2025-12-09'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-09'
  ...
  where a.sharepoint_id = 463
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 536, e.id, c.id, t.id, 'Cadre de la porte de la salle de bain à fixer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-09', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-04-29'
  ...
  where a.sharepoint_id = 621
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 685, e.id, c.id, t.id, 'changer connecteur lumiéres miroir SDB', null, 'validee', u1.id, u2.id, timestamptz '2025-11-09', '2025-12-09'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'changer connecteur lumiéres miroir SDB'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-09'
  ...
  where a.sharepoint_id = 685
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 869, e.id, c.id, t.id, 'Spot plafond derrière la réception à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-09', '2025-12-09'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-09'
  ...
  where a.sharepoint_id = 869
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 619, e.id, c.id, t.id, 'Refixer la liseuse de gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-09-09', null
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2025-09-13'
  ...
  where a.sharepoint_id = 1129
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 478, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-07-09', '2025-12-09'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-09'
  ...
  where a.sharepoint_id = 478
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 591, e.id, c.id, t.id, 'L''eau coule dans la cuvette des WC', 'nécéssite le changement complet du mécanisme de chasse d''eau selon passage Hedi du 18.09 - Finalement joints effectués lors du passage du 20.09', 'validee', u1.id, u2.id, timestamptz '2025-07-09', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 591
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 669, e.id, c.id, t.id, 'barriere de douche à fixer', null, 'validee', u1.id, u2.id, timestamptz '2025-07-09', '2025-09-18'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'barriere de douche à fixer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 669
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 730, e.id, c.id, t.id, 'Refixer correctement le miroir grossissant au mur SDB', null, 'validee', u1.id, u2.id, timestamptz '2025-07-09', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 730
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 747, e.id, c.id, t.id, 'barriere de douche à fixer', null, 'validee', u1.id, u2.id, timestamptz '2025-07-09', '2025-09-18'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'barriere de douche à fixer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 747
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 834, e.id, c.id, t.id, 'Porte d''entrée qui ne se verouille pas - URGENT', null, 'validee', u1.id, u2.id, timestamptz '2025-02-09', '2025-12-09'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'porte d''entrée qui ne se verouille pas - urgent'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-12-09'
  ...
  where a.sharepoint_id = 834
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 831, e.id, c.id, t.id, 'Spot à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-31', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à changer'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = 'Cuisine' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 426, e.id, c.id, t.id, 'L''eau coule dans la cuvette des WC', null, 'validee', u1.id, u2.id, timestamptz '2025-08-28', '2025-09-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'L''eau coule dans la cuvette des WC'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 426
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 448, e.id, c.id, t.id, 'L''eau coule dans la cuvette des WC', 'Selon passage Hedi du 18.09, changelment total du système de chasse d''eau - suite passage du 20/09 - joints effectués', 'validee', u1.id, u2.id, timestamptz '2025-08-28', '2025-09-20'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'L''eau coule dans la cuvette des WC'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
Finalement joints effectués passage Hedi du 20.09', 'validee', u1.id, u2.id, timestamptz '2025-08-28', '2025-09-20'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'L''eau coule dans la cuvette des WC'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 838, e.id, c.id, t.id, 'Ampoule de l''applique à changer', 'Localisation d''origine : escalier qui mène au 1er', 'validee', u1.id, u2.id, timestamptz '2025-08-28', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = 'Parties communes' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 840, e.id, c.id, t.id, 'bloc secour/batterie a changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-28', '2025-10-23'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-10-23'
  ...
  where a.sharepoint_id = 840
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 848, e.id, c.id, t.id, 'bloc secour/batterie a changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-28', '2025-10-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'bloc secour/batterie a changer'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2025-08-18'
  ...
  where a.sharepoint_id = 1131
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 421, e.id, c.id, t.id, 'Flexible fuit au niveau du pommeau de douche', 'flexible remplacé', 'validee', u1.id, u2.id, timestamptz '2025-08-15', '2025-09-18'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible fuit au niveau du pommeau de douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 421
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 425, e.id, c.id, t.id, 'Lit cassé côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-08-15', '2025-09-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lit cassé côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 425
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 709, e.id, c.id, t.id, 'flexible liseuse côté droit à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-15', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté droit à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 709
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 875, e.id, c.id, t.id, 'ecoulement faible eau chasse d''eau vestiaire femme', null, 'validee', u1.id, u2.id, timestamptz '2025-08-15', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 502
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 835, e.id, c.id, t.id, 'Spot côté à changer devant la camera', null, 'validee', u1.id, u2.id, timestamptz '2025-07-31', '2025-04-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 835
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 866, e.id, c.id, t.id, 'Spot côté à changer à côté du miroir', null, 'validee', u1.id, u2.id, timestamptz '2025-07-31', '2025-04-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 866
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 867, e.id, c.id, t.id, 'Spot côté à changer derriere la réception', null, 'validee', u1.id, u2.id, timestamptz '2025-07-31', '2025-04-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 867
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 409, e.id, c.id, t.id, 'Serrer le bras liseuse côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-07-30', '2025-05-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 409
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 533, e.id, c.id, t.id, 'deboucher l''evier', 'Rodica l''a débouché le 31/07/25', 'validee', u1.id, u2.id, timestamptz '2025-07-30', '2025-07-31'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-07-31'
  ...
  where a.sharepoint_id = 533
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 572, e.id, c.id, t.id, 'Vis tombé de la douche à la reception - à la reception', null, 'validee', u1.id, u2.id, timestamptz '2025-07-30', '2025-05-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 572
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 601, e.id, c.id, t.id, 'Vis seche serviette à la reception', null, 'validee', u1.id, u2.id, timestamptz '2025-07-30', '2025-09-26'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 601
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 780, e.id, c.id, t.id, 'Changement du séche cheveux', null, 'validee', u1.id, u2.id, timestamptz '2025-07-27', '2025-07-22'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement du séche cheveux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-14'
  ...
  where a.sharepoint_id = 395
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 860, e.id, c.id, t.id, 'Faire installer la machine café -', null, 'validee', u1.id, u2.id, timestamptz '2025-07-25', '2025-05-08'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 372, e.id, c.id, t.id, 'Vis du haut de la gâche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-07-24', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 372
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 486, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-07-24', '2025-04-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 486
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 809, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-07-24', '2025-04-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 809
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 855, e.id, c.id, t.id, 'bloc secour/batterie a changer (en face de la chambre 14)', null, 'validee', u1.id, u2.id, timestamptz '2025-07-24', '2025-04-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 855
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 635, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-11-07', '2025-11-07'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-07'
  ...
  where a.sharepoint_id = 635
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 653, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-11-07', '2025-11-07'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-07'
  ...
  where a.sharepoint_id = 653
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 670, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-11-07', '2025-11-07'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-07'
  ...
  where a.sharepoint_id = 670
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 827, e.id, c.id, t.id, 'Ampoule de la suspension lumineuse à côté de l''ascenseur qui clignote parfois', 'PB non constaté, changement de l''ampoule par précaution', 'validee', u1.id, u2.id, timestamptz '2025-08-07', '2025-04-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 827
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 577, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-06-25', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-24'
  ...
  where a.sharepoint_id = 577
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 645, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-06-24', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
Localisation d''origine : Divers', 'validee', u1.id, u2.id, timestamptz '2025-06-24', '2025-06-24'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-24'
  ...
  where a.sharepoint_id = 833
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 828, e.id, c.id, t.id, 'Spot à changer (celui de droite)', null, 'validee', u1.id, u2.id, timestamptz '2025-06-21', '2025-04-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-08'
  ...
  where a.sharepoint_id = 828
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 854, e.id, c.id, t.id, 'Spot à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-06-21', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-24'
  ...
  where a.sharepoint_id = 854
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 624, e.id, c.id, t.id, 'Joint pour faire tenir le pommeau de douche', null, 'validee', u1.id, u2.id, timestamptz '2025-09-06', '2025-09-26'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-04-29'
  ...
  where a.sharepoint_id = 599
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 579, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-02-06', '2025-04-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 688, e.id, c.id, t.id, 'Mur gauche côté fenêtre endommagé', null, 'a_faire', u1.id, u2.id, timestamptz '2025-02-06', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '46' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 571, e.id, c.id, t.id, 'flexible douche qui fuit', 'flexible remplacé', 'validee', u1.id, u2.id, timestamptz '2025-01-06', '2025-09-18'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible douche qui fuit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 571
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 813, e.id, c.id, t.id, 'flexible douche qui fuit', 'joint', 'validee', u1.id, u2.id, timestamptz '2025-01-06', '2025-05-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible douche qui fuit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 813
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 863, e.id, c.id, t.id, 'Porte d''entrée qui grince', null, 'validee', u1.id, u2.id, timestamptz '2025-01-06', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 863
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 389, e.id, c.id, t.id, 'joint étanchéité pare douche', null, 'validee', u1.id, u2.id, timestamptz '2025-05-30', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 389
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 578, e.id, c.id, t.id, 'joint étanchéité pare douche', null, 'validee', u1.id, u2.id, timestamptz '2025-05-30', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint étanchéité pare douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 578
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 637, e.id, c.id, t.id, 'joint étanchéité pare douche', null, 'validee', u1.id, u2.id, timestamptz '2025-05-30', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint étanchéité pare douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 637
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 862, e.id, c.id, t.id, 'recoller les cornières dorées sur les deux pilliers', null, 'validee', u1.id, u2.id, timestamptz '2025-05-30', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'recoller les cornières dorées sur les deux pilliers'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 862
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 881, e.id, c.id, t.id, 'Robinet à changer + flexible', 'Remise en état de la douchette ainsi que le flexible et le robinet - victoria a trouvé un robinet ainsi qu''un flexible en stock', 'validee', u1.id, u2.id, timestamptz '2025-05-30', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 559
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 636, e.id, c.id, t.id, 'joint sillicone lavabo et douche', null, 'validee', u1.id, u2.id, timestamptz '2025-05-20', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 636
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 694, e.id, c.id, t.id, 'joint sillicone lavabo douche et WC', null, 'validee', u1.id, u2.id, timestamptz '2025-05-20', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 694
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 708, e.id, c.id, t.id, 'joint sillicone lavabo', null, 'validee', u1.id, u2.id, timestamptz '2025-05-20', '2025-06-24'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 586, e.id, c.id, t.id, 'Bouton pour le mitigeur douche à changer', null, 'a_faire', u1.id, u2.id, timestamptz '2025-05-19', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '35' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 659, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-05-18', '2025-05-20'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-20'
  ...
  where a.sharepoint_id = 659
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 522, e.id, c.id, t.id, 'Refixer la prise', null, 'validee', u1.id, u2.id, timestamptz '2025-05-16', '2025-05-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'refixer la prise'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 552, e.id, c.id, t.id, 'Serrer le bras liseuse côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-04-29', '2025-04-29'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-29'
  ...
  where a.sharepoint_id = 552
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 532, e.id, c.id, t.id, 'support de douche à viser', null, 'validee', u1.id, u2.id, timestamptz '2025-04-24', '2025-04-25'
  from emplacements e
...
Pas d''agrafeuse lors du passage hedi le 18.09', 'validee', u1.id, u2.id, timestamptz '2025-04-24', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Lit côté droit cassé'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 598
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 544, e.id, c.id, t.id, 'Refixer la liseuse de gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-04-23', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer la liseuse de gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 544
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 546, e.id, c.id, t.id, 'Télérupteur à changer - spot et leds', null, 'validee', u1.id, u2.id, timestamptz '2025-04-22', '2025-04-23'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Télérupteur à changer - spot et leds'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-23'
  ...
  where a.sharepoint_id = 546
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 847, e.id, c.id, t.id, 'Cache Rosace de la poignée (exterieure) de porte à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-04-17', '2025-12-23'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 482, e.id, c.id, t.id, 'Fissure constaté au plafond', null, 'a_faire', u1.id, u2.id, timestamptz '2025-04-15', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '21' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 758, e.id, c.id, t.id, 'télérupteur lumière néons et spots plafond sautent', null, 'validee', u1.id, u2.id, timestamptz '2025-04-15', '2025-04-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-18'
  ...
  where a.sharepoint_id = 758
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 678, e.id, c.id, t.id, 'remplacer l''économiseur d''énergie pour éclairage principal', null, 'validee', u1.id, u2.id, timestamptz '2025-04-14', '2025-05-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'remplacer l''économiseur d''énergie pour éclairage principal'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-14'
  ...
  where a.sharepoint_id = 678
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 477, e.id, c.id, t.id, 'Télérupteur à changer appliques', 'contrôle le 14 Avril 2025, plus de pb apparent', 'validee', u1.id, u2.id, timestamptz '2025-04-13', null
  from emplacements e
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '21' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 566, e.id, c.id, t.id, 'joint sillicone dans le bac à douche', null, 'validee', u1.id, u2.id, timestamptz '2025-10-04', '2025-04-29'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-29'
  ...
  where a.sharepoint_id = 566
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 603, e.id, c.id, t.id, 'joint sillicone dans le bac à douche', null, 'validee', u1.id, u2.id, timestamptz '2025-10-04', '2025-04-29'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint sillicone dans le bac à douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-29'
  ...
  where a.sharepoint_id = 603
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 613, e.id, c.id, t.id, 'Joint de pare douche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 613
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 646, e.id, c.id, t.id, 'joint pare douche à remplacer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 646
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 656, e.id, c.id, t.id, 'Joint pare douche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 656
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 657, e.id, c.id, t.id, 'remettre le joint noir porte coulissante SDB qui est decollé', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 657
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 673, e.id, c.id, t.id, 'Joint pare douche à changer car laisse passer l''eau', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 673
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 749, e.id, c.id, t.id, 'joint pare douche à remplacer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint pare douche à remplacer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 749
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 750, e.id, c.id, t.id, 'Resserer liseuse côté droit', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 750
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 776, e.id, c.id, t.id, 'Refixer correctement le miroir grossissant au mur SDB', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer correctement le miroir grossissant au mur SDB'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 776
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 821, e.id, c.id, t.id, '4 eme spot plafond couloir du fond à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 821
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 868, e.id, c.id, t.id, 'Resserer liseuse gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-08-04', '2025-08-04'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 872, e.id, c.id, t.id, 'Système carte pour lumière chambre cassé', 'à commander dormakaba Sarah ? - en déjà en stock', 'validee', u1.id, u2.id, timestamptz '2025-08-04', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = 'Réception' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 373, e.id, c.id, t.id, 'Flexible douche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-07-04', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible douche à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 373
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 592, e.id, c.id, t.id, 'Refixer la liseuse de gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-07-04', '2025-04-29'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer la liseuse de gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-04-29'
  ...
  where a.sharepoint_id = 592
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 612, e.id, c.id, t.id, 'Refixer la liseuse de droite', null, 'validee', u1.id, u2.id, timestamptz '2025-07-04', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'refixer la liseuse de droite'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 797, e.id, c.id, t.id, 'Charnière de la porte du bas à changer', null, 'a_faire', u1.id, u2.id, timestamptz '2025-07-04', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '57' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 424, e.id, c.id, t.id, 'Joint pare douche', null, 'validee', u1.id, u2.id, timestamptz '2025-01-04', '2025-09-26'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 424
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 443, e.id, c.id, t.id, 'flexible douche à changer', 'Apres verification par Victoria, il faut fixer de nouveau le flexible parce que ça fuit encore - Victoria l''a changé le 15/04/25 il faut juste verifier si c''est bien fait', 'validee', u1.id, u2.id, timestamptz '2025-01-04', '2025-11-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible douche à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-14'
  ...
  where a.sharepoint_id = 699
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 748, e.id, c.id, t.id, 'Joint pare douche', null, 'validee', u1.id, u2.id, timestamptz '2025-01-04', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Joint pare douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-21'
  ...
  where a.sharepoint_id = 545
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 553, e.id, c.id, t.id, 'télérupteur lumière néons et spots plafond sautent', null, 'validee', u1.id, u2.id, timestamptz '2025-03-25', '2025-04-18'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'télérupteur lumière néons et spots plafond sautent'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-21'
  ...
  where a.sharepoint_id = 740
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 870, e.id, c.id, t.id, 'Spot côté gauche du bar à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-03-24', '2025-01-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-04-27'
  ...
  where a.sharepoint_id = 978
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 849, e.id, c.id, t.id, 'Réparation de la poignée de porte du TGBT', null, 'validee', u1.id, u2.id, timestamptz '2025-03-20', '2025-03-20'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-20'
  ...
  where a.sharepoint_id = 849
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 757, e.id, c.id, t.id, 'Evier qui coule', null, 'validee', u1.id, u2.id, timestamptz '2025-12-03', '2025-05-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-04-29'
  ...
  where a.sharepoint_id = 378
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 381, e.id, c.id, t.id, 'Lit côté gauche cassé', 'pas d''agrafeuse sur lui le 18.09 - prochain passage', 'validee', u1.id, u2.id, timestamptz '2025-11-03', '2025-09-26'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lit côté gauche cassé'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-26'
  ...
  where a.sharepoint_id = 381
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 390, e.id, c.id, t.id, 'Serrer le bras liseuse côté gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-11-03', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 436, e.id, c.id, t.id, 'Joint pare douche', 'Pas besoin selon visite HEDI le 5/08 -Pas de solution perenne / baghuette propre', 'validee', u1.id, u2.id, timestamptz '2025-11-03', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '15' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 655, e.id, c.id, t.id, 'Lavabo qui coule', 'Aucune fuite constatée lors du passage du 08/04/25', 'validee', u1.id, u2.id, timestamptz '2025-11-03', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Lavabo qui coule'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '45' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 818, e.id, c.id, t.id, 'Spot à coté de l''ascenseur à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-03', '2025-01-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à coté de l''ascenseur à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-04'
  ...
  where a.sharepoint_id = 818
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 858, e.id, c.id, t.id, 'Spot devant la chambre 34 à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-03', '2025-01-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-04'
  ...
  where a.sharepoint_id = 858
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 690, e.id, c.id, t.id, 'Mettre une vis pour l''aimant de la porte dorée armoire (bas)', null, 'validee', u1.id, u2.id, timestamptz '2025-02-21', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 690
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 698, e.id, c.id, t.id, 'Mettre une vis pour l''aimant de la porte dorée armoire (haut)', '26/09/25 - Hedi dit que quelqu''un l''a lors de son passage,', 'validee', u1.id, u2.id, timestamptz '2025-02-21', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Mettre une vis pour l''aimant de la porte dorée armoire (haut)'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '47' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 371, e.id, c.id, t.id, 'Recoller la plinthe bois noire porte SDB côté SDB', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 371
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 374, e.id, c.id, t.id, 'URGENT - Joints sillicone douche - lavabo et WC à refaire complètement', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'urgent - joints sillicone douche - lavabo et wc à refaire complètement'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 374
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 377, e.id, c.id, t.id, 'Difficulté à fermer la porte de chambre -', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'difficulté à fermer la porte de chambre -'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
  left join utilisateurs u2 on u2.nom = 'Victoria'
  where e.code = '01' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 382, e.id, c.id, t.id, 'URGENT - Joints sillicone douche et lavabo à refaire complètement', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 382
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 388, e.id, c.id, t.id, 'URGENT - Joints sillicone douche - lavabo & WC', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-05-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-24'
  ...
  where a.sharepoint_id = 401
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 402, e.id, c.id, t.id, 'URGENT - Joints sillicone douche', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'urgent - joints sillicone douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 410, e.id, c.id, t.id, 'Changer le miroir SDB car rouillé de l''interieur', 'A voir avec Marie & Andrea si on change le miroir', 'a_acheter', u1.id, u2.id, timestamptz '2025-02-18', null
  ...
  left join utilisateurs u2 on u2.nom = 'Victoria'
  where e.code = '11' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 414, e.id, c.id, t.id, 'URGENT - Joints sillicone douche et lavabo à refaire complètement', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'URGENT - Joints sillicone douche et lavabo à refaire complètement'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 422, e.id, c.id, t.id, 'Bouton pour le mitigeur douche à acheter car il n''y en a plus', 'selon Hedi, pas possible de dévisser - il faudrait changer le mitigeur complet', 'a_acheter', u1.id, u2.id, timestamptz '2025-02-18', null
  ...
  left join utilisateurs u2 on u2.nom = 'Victoria'
  where e.code = '12' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 423, e.id, c.id, t.id, 'URGENT - Joints sillicone douche - lavabo', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-09-26'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-02'
  ...
  where a.sharepoint_id = 431
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 441, e.id, c.id, t.id, 'URGENT - Joints sillicone douche et lavabo à refaire complètement', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-01-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'URGENT - Joints sillicone douche et lavabo à refaire complètement'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 454
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 460, e.id, c.id, t.id, 'URGENT - Joints sillicone douche', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'urgent - joints sillicone douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-24'
  ...
  where a.sharepoint_id = 460
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 467, e.id, c.id, t.id, 'Spot plafond entrée HS', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', '2025-01-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-02'
  ...
  where a.sharepoint_id = 608
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 672, e.id, c.id, t.id, 'Lampe bureau cassée - faire réparer comme M Negroni', null, 'validee', u1.id, u2.id, timestamptz '2025-02-18', null
  from emplacements e
...
insert into interventions (anomalie_id, tournee_id, technicien_id, prestataire_id, date_intervention, cree_le) select a.id, t.id, u.id, p.id, date '2025-02-18', timestamptz '2025-02-18'
  ...
  where a.sharepoint_id = 672
    and not exists (select 1 from interventions i where i.anomalie_id = a.id);
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 515, e.id, c.id, t.id, 'Refixer la liseuse de gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-02-17', '2025-05-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer la liseuse de gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 600, e.id, c.id, t.id, 'Manque porte placard du haut', 'Récupérée par Farid le 17/02 pour emmener à l''atelier', 'a_faire', u1.id, u2.id, timestamptz '2025-02-17', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '36' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 658, e.id, c.id, t.id, 'Remplacement de la bonde lavabo', null, 'validee', u1.id, u2.id, timestamptz '2025-02-17', '2025-02-17'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 662, e.id, c.id, t.id, 'De l''eau coule à l''interier depuis la fenetre', null, 'a_faire', u1.id, u2.id, timestamptz '2025-02-17', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '45' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 403, e.id, c.id, t.id, 'Serrer le bras liseuse côté droit', null, 'validee', u1.id, u2.id, timestamptz '2025-02-15', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté droit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 404
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 806, e.id, c.id, t.id, 'Serrer le bras liseuse côté droit', null, 'validee', u1.id, u2.id, timestamptz '2025-02-15', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'serrer le bras liseuse côté droit'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 806
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 718, e.id, c.id, t.id, 'joint sillicone dans le bac à douche', null, 'validee', u1.id, u2.id, timestamptz '2025-02-14', '2025-06-24'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint sillicone dans le bac à douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-16'
  ...
  where a.sharepoint_id = 741
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 756, e.id, c.id, t.id, 'joint sillicone dans le bac à douche et lavabo', null, 'validee', u1.id, u2.id, timestamptz '2025-02-14', '2025-01-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-06-15'
  ...
  where a.sharepoint_id = 785
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 790, e.id, c.id, t.id, 'joint sillicone dans le bac à douche', null, 'validee', u1.id, u2.id, timestamptz '2025-02-14', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint sillicone dans le bac à douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-30'
  ...
  where a.sharepoint_id = 790
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 804, e.id, c.id, t.id, 'joint sillicone dans le bac à douche', null, 'validee', u1.id, u2.id, timestamptz '2025-02-14', '2025-05-30'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'joint sillicone dans le bac à douche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 837, e.id, c.id, t.id, 'La moquette de la premiere marche en partant du haut est decollée', null, 'a_faire', u1.id, u2.id, timestamptz '2025-02-13', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = 'Palier 1er' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 498, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 498
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 568, e.id, c.id, t.id, 'Changement des rideaux - salle de bain', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 568
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 677, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 677
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 720, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 720
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 734, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 734
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 754, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 754
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 755, e.id, c.id, t.id, 'Changement des rideaux - salle de bain', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux - salle de bain'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 755
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 767, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 767
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 779, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 779
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 793, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 793
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 807, e.id, c.id, t.id, 'Changement des rideaux', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 807
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 808, e.id, c.id, t.id, 'Changement des rideaux - salle de bain', null, 'validee', u1.id, u2.id, timestamptz '2025-12-02', '2025-03-14'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux - salle de bain'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-14'
  ...
  where a.sharepoint_id = 808
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 416, e.id, c.id, t.id, 'Refixer la liseuse de droite', null, 'validee', u1.id, u2.id, timestamptz '2025-09-02', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'refixer la liseuse de droite'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 416
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 429, e.id, c.id, t.id, 'Refixer la liseuse de gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-09-02', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer la liseuse de gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 585, e.id, c.id, t.id, 'Il manque la porte du placard du bas', null, 'a_faire', u1.id, u2.id, timestamptz '2025-09-02', null
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '35' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 461, e.id, c.id, t.id, 'lampe bureau à réparer', 'OK REMISE EN CHAMBRE', 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-06-02'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-02'
  ...
  where a.sharepoint_id = 461
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 537, e.id, c.id, t.id, 'lampe bureau à réparer', 'OK REMISE EN CHAMBRE', 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-06-02'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lampe bureau à réparer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-02'
  ...
  where a.sharepoint_id = 537
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 638, e.id, c.id, t.id, 'lampe bureau à réparer', 'OK REMISE EN CHAMBRE', 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-06-02'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lampe bureau à réparer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-02'
  ...
  where a.sharepoint_id = 638
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 719, e.id, c.id, t.id, 'Manque porte placard ( grande) / visser aimant', null, 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-07-02'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-14'
  ...
  where a.sharepoint_id = 742
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 752, e.id, c.id, t.id, 'lampe bureau à réparer', 'OK REMISE EN CHAMBRE', 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-06-02'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lampe bureau à réparer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 771, e.id, c.id, t.id, 'lampe bureau à réparer', 'Réparation M Negroni ok, manque juste l''ampoule ( lampe dans le local technique) - @ réception le 18/02 car nous avons trouvé une lampe fonctionnelle en 55... Nous ne savons pas où mettre la lampe qui se trouve au sous sol', 'validee', u1.id, u2.id, timestamptz '2025-07-02', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '55' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 777, e.id, c.id, t.id, 'lampe bureau à réparer', 'OK REMISE EN CHAMBRE', 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-06-02'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lampe bureau à réparer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-02'
  ...
  where a.sharepoint_id = 777
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 791, e.id, c.id, t.id, 'Prise arrachée du mur SDB', null, 'validee', u1.id, u2.id, timestamptz '2025-07-02', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'prise arrachée du mur sdb'
  left join types_intervention t on t.code = 'ELECTRIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 791
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 846, e.id, c.id, t.id, 'Installer un interupteur', 'A la demande de Mr Negroni - fait par Alain', 'validee', u1.id, u2.id, timestamptz '2025-06-02', null
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 851, e.id, c.id, t.id, 'faire un trou et ensuite avec un fil de fer tirer les fils pour installer la prise pour le nouveau cadre', 'Vu entre Marie et Alain pour l''intervention', 'validee', u1.id, u2.id, timestamptz '2025-06-02', null
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 557
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 654, e.id, c.id, t.id, 'flexible liseuse côté gauche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-05-02', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté gauche à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 654
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 671, e.id, c.id, t.id, 'Support gel douche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-05-02', '2025-08-04'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 671
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 707, e.id, c.id, t.id, 'Joint porte sdb', null, 'validee', u1.id, u2.id, timestamptz '2025-05-02', '2025-06-24'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-06-24'
  ...
  where a.sharepoint_id = 707
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 739, e.id, c.id, t.id, 'Lavabo qui coule', null, 'validee', u1.id, u2.id, timestamptz '2025-05-02', '2025-05-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Lavabo qui coule'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-02'
  ...
  where a.sharepoint_id = 564
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 583, e.id, c.id, t.id, 'flexible liseuse côté droit à resserer', null, 'validee', u1.id, u2.id, timestamptz '2025-04-02', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté droit à resserer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-08-04'
  ...
  where a.sharepoint_id = 583
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 594, e.id, c.id, t.id, 'Refixer la liseuse de gauche', null, 'validee', u1.id, u2.id, timestamptz '2025-04-02', '2025-07-02'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer la liseuse de gauche'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-07-02'
  ...
  where a.sharepoint_id = 594
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 614, e.id, c.id, t.id, 'flexible liseuse côté gauche à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-04-02', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté gauche à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'gouvernante', 'validee', u.id, timestamptz '2026-05-02'
  ...
  where a.sharepoint_id = 812
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'gouvernante');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 873, e.id, c.id, t.id, 'Neon salle de repos à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-01-02', '2025-03-20'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Neon salle de repos à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-20'
  ...
  where a.sharepoint_id = 873
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 983, e.id, c.id, t.id, 'Changement des rideaux', 'Dégâts fait par le technicien Avir', 'validee', u1.id, u2.id, timestamptz '2025-01-29', '2026-03-31'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Changement des rideaux'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2026-03-31'
  ...
  where a.sharepoint_id = 983
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 457, e.id, c.id, t.id, 'URGENT! PRIORITE Coffre à reprogrammer', null, 'validee', u1.id, u2.id, timestamptz '2025-01-28', '2025-03-11'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'urgent! priorite coffre à reprogrammer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-03-11'
  ...
  where a.sharepoint_id = 457
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 415, e.id, c.id, t.id, 'Spot plafond niveau armoire à changer', 'Apparemment déjà fait', 'validee', u1.id, u2.id, timestamptz '2025-01-27', '2025-02-17'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 428
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 627, e.id, c.id, t.id, 'flexible liseuse côté SDB à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-01-27', '2025-01-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-30'
  ...
  where a.sharepoint_id = 627
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 650, e.id, c.id, t.id, 'Barrre de douche à refixer', null, 'validee', u1.id, u2.id, timestamptz '2025-01-27', '2025-01-30'
  from emplacements e
...
Localisation d''origine : GENERAL', 'validee', u1.id, u2.id, timestamptz '2025-01-23', null
  from emplacements e
...
insert into interventions (anomalie_id, tournee_id, technicien_id, prestataire_id, date_intervention, cree_le) select a.id, t.id, u.id, p.id, date '2025-01-23', timestamptz '2025-01-23'
  ...
  where a.sharepoint_id = 842
    and not exists (select 1 from interventions i where i.anomalie_id = a.id);
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 411, e.id, c.id, t.id, 'changement du flexible de la liseuse de droite', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
...
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 491, e.id, c.id, t.id, 'problème de joint sur la paroi de douche car l''eau coule à travers -', '6 baguettes joints neuves déposées par M Negroni le 24/01 pour pare douches dans la lingerie -', 'validee', u1.id, u2.id, timestamptz '2025-01-21', null
  ...
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '22' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 521, e.id, c.id, t.id, 'Mettre une vis pour l''aimant de la porte dorée armoire (bas)', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Mettre une vis pour l''aimant de la porte dorée armoire (bas)'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 521
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 523, e.id, c.id, t.id, 'flexible liseuse côté droit à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-08-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'flexible liseuse côté droit à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 524
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 530, e.id, c.id, t.id, 'Refixer la liseuse de droite', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'refixer la liseuse de droite'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
  left join utilisateurs u2 on u2.nom = 'Sarah P'
  where e.code = '27' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 531, e.id, c.id, t.id, 'Plainte rose coté lit SDB à recoller', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-05-08'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 531
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 538, e.id, c.id, t.id, 'La porte principale ne se fermait pas bien', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'La porte principale ne se fermait pas bien'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 538
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 582, e.id, c.id, t.id, 'Mettre une vis pour l''aimant de la porte dorée armoire (haut)', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Mettre une vis pour l''aimant de la porte dorée armoire (haut)'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '35' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 607, e.id, c.id, t.id, 'Plinthe bois chambre (Mur a gauche du lit) à recoller', 'Collé ok - faire le joint et repeindre la plinthe  - selon Hedi déjà fait lors du passage du 18.09', 'validee', u1.id, u2.id, timestamptz '2025-01-21', null
  from emplacements e
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '37' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 684, e.id, c.id, t.id, 'Fuite syphon Lavabo SDB', 'fait le 21/01 mais fuit de nouveau le 24/01 - 30/01/25, le joint à été enlevé par Farid et Mr Jacques', 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 732
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 737, e.id, c.id, t.id, 'Mettre une vise sur la Porte dorée armoire (haut)', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 738
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 751, e.id, c.id, t.id, 'Refixer le miroir grossissant', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-02-17'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Refixer le miroir grossissant'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Sarah P'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 751
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 770, e.id, c.id, t.id, 'Baguette d''angle noir a recollé - mur entree chambre', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 770
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 778, e.id, c.id, t.id, 'Fuite syphon Lavabo SDB', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Fuite syphon Lavabo SDB'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 778
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 865, e.id, c.id, t.id, 'coller deux baguettes d''angle noires dans l''encadrement porte DAES', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 865
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 877, e.id, c.id, t.id, 'Mettre le tableau pour l''affichage obligatoire', null, 'validee', u1.id, u2.id, timestamptz '2025-01-21', '2025-01-21'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-21'
  ...
  where a.sharepoint_id = 877
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 817, e.id, c.id, t.id, 'Spot du couloir a changer à coté de la chambre 18', null, 'validee', u1.id, u2.id, timestamptz '2025-01-16', '2025-01-30'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-30'
  ...
  where a.sharepoint_id = 817
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 440, e.id, c.id, t.id, 'Porte du frigo à fixer', null, 'validee', u1.id, u2.id, timestamptz '2025-11-01', '2025-05-08'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'porte du frigo à fixer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-05-08'
  ...
  where a.sharepoint_id = 440
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 649, e.id, c.id, t.id, 'Lavabo bouché', null, 'validee', u1.id, u2.id, timestamptz '2025-11-01', '2025-01-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'lavabo bouché'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-16'
  ...
  where a.sharepoint_id = 649
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 723, e.id, c.id, t.id, 'Bouton on/off pour regler la temperature non fonctionnel', null, 'validee', u1.id, u2.id, timestamptz '2025-11-01', null
  from emplacements e
  ...
  left join utilisateurs u2 on u2.nom = 'Miguel'
  where e.code = '51' on conflict (sharepoint_id) do nothing;
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 805, e.id, c.id, t.id, 'La lumiere du miroir ne s''allume pas', null, 'validee', u1.id, u2.id, timestamptz '2025-11-01', '2025-02-17'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 805
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 417, e.id, c.id, t.id, 'joint porte sdb', null, 'validee', u1.id, u2.id, timestamptz '2025-09-01', '2025-11-01'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Joint porte sdb'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-01'
  ...
  where a.sharepoint_id = 417
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 497, e.id, c.id, t.id, 'change bonde lavabo', null, 'validee', u1.id, u2.id, timestamptz '2025-09-01', '2025-02-17'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 497
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 511, e.id, c.id, t.id, 'deboucher l''evier', null, 'validee', u1.id, u2.id, timestamptz '2025-09-01', '2025-11-01'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'deboucher l''evier'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-11-01'
  ...
  where a.sharepoint_id = 511
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 529, e.id, c.id, t.id, 'deboucher l''evier', null, 'validee', u1.id, u2.id, timestamptz '2025-09-01', null
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'deboucher l''evier'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-22'
  ...
  where a.sharepoint_id = 560
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 731, e.id, c.id, t.id, 'changer la bonde du lavabo', null, 'validee', u1.id, u2.id, timestamptz '2025-09-01', '2025-02-17'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-02-17'
  ...
  where a.sharepoint_id = 731
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 783, e.id, c.id, t.id, 'deboucher l''evier', null, 'validee', u1.id, u2.id, timestamptz '2025-09-01', '2025-01-16'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'deboucher l''evier'
  left join types_intervention t on t.code = 'PLOMBERIE'
  left join utilisateurs u1 on u1.nom = 'Victoria'
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-01-16'
  ...
  where a.sharepoint_id = 783
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 387, e.id, c.id, t.id, 'Applique coté entrée à refixer correctement', null, 'validee', u1.id, u2.id, timestamptz '2025-05-01', '2025-09-18'
  from emplacements e
...
insert into validations (intervention_id, acteur, decision, utilisateur_id, decide_le) select i.id, 'technicien', 'fait', u.id, timestamptz '2025-09-18'
  ...
  where a.sharepoint_id = 387
    and not exists (select 1 from validations v where v.intervention_id = i.id and v.acteur = 'technicien');
insert into anomalies (sharepoint_id, emplacement_id, catalogue_id, type_id, description, commentaire, statut, constate_par, saisie_par, declare_le, cloture_le) select 822, e.id, c.id, t.id, 'Spot à coté de l''ascenseur à changer', null, 'validee', u1.id, u2.id, timestamptz '2025-05-01', '2025-01-04'
  from emplacements e
  left join catalogue_anomalies c on c.libelle = 'Spot à coté de l''ascenseur à changer'
  left join types_intervention t on t.code = 'TECHNIQUE'
  left join utilisateurs u1 on u1.nom = 'Miguel'
