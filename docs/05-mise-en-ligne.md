...
|---|---|---|
| `1-schema-et-referentiels.sql` | Tables, vues, règles, sécurité, 70 emplacements, 268 libellés | 120 Ko |
| `2-anomalies.sql` | 670 anomalies, 528 interventions, 29 tournées | 964 Ko |
